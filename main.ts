...
let pladehastighed = 0
let plade: Sprite = null
...
info.setScore(0)
info.setLife(240)
controller.moveSprite(plade, pladehastighed, 0)
pladehastighed = 100
...
mySprite.setPosition(75, 107)
for (let indexy = 0; indexy <= 11; indexy++) {
...
8 8 8 8 8 8 8 8 
`, SpriteKind.Block)
        mySprite2.setPosition(4 + 8 * index, 4 + 8 * indexy)
    }
}
